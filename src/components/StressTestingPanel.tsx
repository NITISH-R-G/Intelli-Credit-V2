...
interface StressTestingPanelProps {
  revenueShock: number;
  setRevenueShock: (value: number) => void;
  interestRateShock: number;
  setInterestRateShock: (value: number) => void;
  analysis: CreditAnalysis;
  displayAnalysis: CreditAnalysis | null;
}

export const StressTestingPanel = ({
  revenueShock,
  setRevenueShock,
  interestRateShock,
