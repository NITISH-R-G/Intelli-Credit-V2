...
describe('FiveCsAnalysis', () => {
  ...
  const mockAnalysis: CreditAnalysis = {
    ...
    fiveCs: {
      character: { score: 80, insights: ['Strong history.'], redFlags: [], positiveSignals: ['Good rep'] },
      ...
      collateral: { score: 80, insights: ['Solid assets.'], redFlags: [], positiveSignals: [], assets: [{ type: 'Land', marketValue: 100000000, estimatedValue: 80000000, ltvRatio: 0.8, remarks: 'Good' }] },
      conditions: { score: 70, insights: ['Stable market.'], redFlags: ['Recession risk'], positiveSignals: [] }
    },
    fraudDetection: [
