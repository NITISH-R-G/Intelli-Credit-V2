...
graph TD;
  ...
  Root__github --> Root__github_release_drafter_yml["release-drafter.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_license_compliance_yml["license-compliance.yml"]
  Root__github_workflows --> Root__github_workflows_link_checker_yml["link-checker.yml"]
  Root__github_workflows --> Root__github_workflows_merge_conflict_resolver_yml["merge-conflict-resolver.yml"]
  Root__github_workflows --> Root__github_workflows_release_yml["release.yml"]
  ...
  Root_scripts_automation --> Root_scripts_automation_issue_manager_ts["issue-manager.ts"]
