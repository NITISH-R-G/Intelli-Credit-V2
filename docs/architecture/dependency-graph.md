...
graph TD;
  ...
  Root__github_workflows --> Root__github_workflows_issue_management_yml["issue-management.yml"]
  Root__github_workflows --> Root__github_workflows_labeler_yml["labeler.yml"]
  Root__github_workflows --> Root__github_workflows_pages_yml["pages.yml"]
