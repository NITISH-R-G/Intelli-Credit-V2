...
graph TD;
  ...
  Root__github_ISSUE_TEMPLATE --> Root__github_ISSUE_TEMPLATE_security_report_yml["security_report.yml"]
  Root__github_ISSUE_TEMPLATE --> Root__github_ISSUE_TEMPLATE_technical_debt_yml["technical_debt.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_autonomous_improver_yml["autonomous-improver.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_github_pages_yml["github-pages.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_lock_threads_yml["lock-threads.yml"]
  Root__github_workflows --> Root__github_workflows_ossf_scorecard_yml["ossf-scorecard.yml"]
  Root__github_workflows --> Root__github_workflows_repo_health_dashboard_yml["repo-health-dashboard.yml"]
  Root__github_workflows --> Root__github_workflows_sbom_yml["sbom.yml"]
  ...
  Root_docs_architecture --> Root_docs_architecture_knowledge_graph_md["knowledge-graph.md"]
  Root_docs --> Root_docs_dashboard_html["dashboard.html"]
  Root_docs --> Root_docs_knowledge_graph_json["knowledge-graph.json"]
  Root_docs --> Root_docs_technical_debt_report_md["technical-debt-report.md"]
  ...
  Root_scripts_automation --> Root_scripts_automation_autonomous_improver_ts["autonomous-improver.ts"]
