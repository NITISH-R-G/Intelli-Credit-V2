...
graph TD;
  ...
  Root__github_workflows --> Root__github_workflows_issue_ai_triage_yml["issue-ai-triage.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_release_drafter_yml["release-drafter.yml"]
