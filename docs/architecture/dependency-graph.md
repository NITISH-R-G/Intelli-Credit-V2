...
graph TD;
  ...
  Root_scripts_automation --> Root_scripts_automation_continuous_improvement_ts["continuous-improvement.ts"]
  ...
  Root_scripts_automation --> Root_scripts_automation_issue_triager_ts["issue-triager.ts"]
