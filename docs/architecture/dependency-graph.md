...
graph TD;
  ...
  Root_docs_architecture --> Root_docs_architecture_KNOWLEDGE_GRAPH_md["KNOWLEDGE_GRAPH.md"]
  ...
  Root_docs_architecture --> Root_docs_architecture_knowledge_graph_json["knowledge-graph.json"]
