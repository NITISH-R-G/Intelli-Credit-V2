...
graph TD;
  Root["react-example"]
  Root --> Root__devcontainer[".devcontainer"]
  Root__devcontainer --> Root__devcontainer_devcontainer_json["devcontainer.json"]
  ...
  Root__github_workflows --> Root__github_workflows_ai_issue_management_yml["ai-issue-management.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_deploy_pages_yml["deploy-pages.yml"]
  ...
  Root__github_workflows --> Root__github_workflows_release_automation_yml["release-automation.yml"]
  ...
  Root_scripts_automation --> Root_scripts_automation_improve_repo_ts["improve-repo.ts"]
  Root_scripts_automation --> Root_scripts_automation_issue_manage_ts["issue-manage.ts"]
