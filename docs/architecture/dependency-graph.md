...
graph TD;
  ...
  Root__github_workflows --> Root__github_workflows_ai_issue_triage_yml["ai-issue-triage.yml"]
  ...
  Root_scripts_automation --> Root_scripts_automation_ai_issue_triager_ts["ai-issue-triager.ts"]
